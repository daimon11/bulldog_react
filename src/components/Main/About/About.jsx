      ...
      <div className={style.about__wrapper}>
        <div
          ...
          <div className={style.about__paragraf_wrapper}>
            ...
            <p className={style.about__text}>
              8 больших экранов формата FullHD, а так же современная стерео - система позволят вам в полной мере насладиться любимой спортивной трансляцией, не упустив самые важные моменты игры.
            </p>
            <p className={style.about__text}>
            Интерьер, традиционный для английского паба: отделка темным деревом, кожаные диваны и кресла, темные деревянные столы и стулья с мягкими сиденьями.
            </p>
            <p className={style.about__text}>
